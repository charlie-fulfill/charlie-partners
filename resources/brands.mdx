...
<CardGroup cols={2}>
  <Card title="Lockup — dark background" icon="image" href="/images/charlie-lockup-dark.png">
    White mark on ink (`#0a0f1a`). Primary usage.
  </Card>
  <Card title="Lockup — accent background" icon="image" href="/images/charlie-lockup-light.png">
